...
{
	public partial class DrawTriangleWithCircleInsideForm : Form
	{
		public DrawTriangleWithCircleInsideForm()
		{
			try
			{
				InitializeComponent();
			...
			{
				MessageBox.Show("Error TriangleIForm 101");
				Logger.LogError(ex);
			}
		}
		...
		private void panel1_Paint(object sender, PaintEventArgs e)
		{
			...
			{
				MessageBox.Show("Error TriangleIForm 102");
				Logger.LogError(ex);
			}
		}

		private void DrawTriangleWithCircleInsideForm_Resize(object sender, EventArgs e)
		{
			try
			{
				panel1.Location = new Point(10, 10);
			...
			{
				MessageBox.Show("Error TriangleIForm 103");
				Logger.LogError(ex);
			}
		}
		...
		private void ExampleDrawTriangle(Graphics g, Size s)
		{
			try
			{
				...
				{
					myDraw.DrawTriangleWithCircleInside(myPen, A, B, C);
				}
			}
			catch (Exception ex)
			{
				MessageBox.Show("Error TriangleIForm 104");
				Logger.LogError(ex);
			}
		}
	}
